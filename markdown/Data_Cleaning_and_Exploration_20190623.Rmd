...
```{r}
#companies <- read.csv("/Users/mbc400/Box Sync/GitHub/data-cleaning-with-r/datasets/company_dataset.csv", header = TRUE, stringsAsFactors = FALSE)
...
write.csv(dict_only, "/Users/mbc400/Box Sync/GitHub/data-cleaning-with-r/output/companies_dict_only.csv")

# Save as an R dataset, .rds (dataset with appended dictionary)
save_it(complete_dataset, name_of_file = "/Users/mbc400/Box Sync/GitHub/data-cleaning-with-r/output/companies_with_dict")
